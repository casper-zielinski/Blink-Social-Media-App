...
// Cloudinary credentials are read from local.properties (which is gitignored) so the
// secret never ends up in version control. Fill them in there, not here.
...
android {
    namespace = "com.CU.blink"
    compileSdk {
        version = release(36)
    }

    defaultConfig {
        applicationId = "com.CU.blink"
        minSdk = 27
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
